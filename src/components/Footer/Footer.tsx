        ...
        <div className="px-4 py 8 bg-black/90 md:py-40 md:px-36">
            <div className="grid gap-8 grid-cols-2 md:grid-cols-[1fr,1fr,1fr,_400px] text-white">
                ...
                <div className="md:text-right">
                    <h4 className="mb-6 text-xl font-semibold">Inmobiliaria del Sol</h4>
                    <p>Calle inventada, bla bla bla</p>
                    <p>Alto Parana, Paraguay</p>
                    <div className="flex gap-4 mt-5 md:justify-end">
                        <a href="https://www.instagram.com/allamdiaz7/" target="_blank" rel="noopener noreferrer">
                        <LiaInstagram className="text-3xl cursor-pointer" /></a>
